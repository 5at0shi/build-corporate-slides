...
from .components import (add_background_zone, add_card, add_cover, add_item_list,
                         add_focus_panel, add_hairline, add_key_message,
                         add_numbered_row, add_section_lead, add_slide_title)
...
__all__ = [
    ...
    "add_background_zone", "add_card", "add_cover", "add_item_list", "add_focus_panel",
